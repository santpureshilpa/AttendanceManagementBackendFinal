...
public class AttendanceController {
	...
	public ResponseEntity<AttendanceEntity> updateAttendanceById
	(@Valid @PathVariable int attendanceId, @Valid @RequestBody AttendanceEntity entity)
			throws AttendanceIdNotFoundException
	{
		return ResponseEntity.ok(attendanceService.updateAttendanceById(attendanceId,entity));
	}
	...
	public ResponseEntity<AttendanceEntity> getAttendanceById(@PathVariable int attendanceId) throws AttendanceIdNotFoundException
	{
	...
	@PostMapping(path="/addAttendanceWithStudentIdAndSubjectId")
	public ResponseEntity<AttendanceEntity> addAttendWithStudentIdAndSubjectId
	(@Valid @RequestBody AttendanceEntity entity)
			throws StudentNotFoundException, SubjectNotFoundException
	{
		return ResponseEntity.ok(attendanceService.addAttendanceWithStudentIdAndSubjectId(entity));
	}
