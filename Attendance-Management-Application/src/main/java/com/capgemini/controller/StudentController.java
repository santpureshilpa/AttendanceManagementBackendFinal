...
public class StudentController {
	...
	/*
	 * @GetMapping("/students/{studentId}") public ResponseEntity<StudentEntity>
	 * getStudentById(@Valid @PathVariable int studentId) throws
	 * StudentNotFoundException { return new
	 * ResponseEntity<StudentEntity>(studentService.getStudentById(studentId),
	 * HttpStatus.FOUND); }
	 */
	...
	/*
	 * @PostMapping("/addStudentwithCourse/{courseId}") public
	 * ResponseEntity<StudentEntity> addStudentwithC(@Valid @PathVariable int
	 * courseId,@Valid @RequestBody StudentEntity entity) throws
	 * CourseIdNotFoundException, DuplicateRecordException { return new
	 * ResponseEntity<StudentEntity>(studentService.addStudentwithC(entity,courseId)
	 * ,HttpStatus.CREATED); }
	 */
	...
	{
		return new ResponseEntity<StudentEntity>(studentService.addStudentwithC(entity),HttpStatus.CREATED);
	}
